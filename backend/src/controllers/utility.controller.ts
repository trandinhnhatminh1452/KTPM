...
export class UtilityController {
    ...
    async getAllReadings(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            // Xây dựng bộ lọc
            // Nếu là staff, chỉ cho xem các phòng trong building mình quản lý
            ...
            if (requesterRole === 'STAFF') {
                ...
                if (staffProfile?.managedBuildingId) {
                    // Lọc theo các phòng trong building mình quản lý
                    options.where!.room = {
            ...
            // Nếu có roomId cụ thể thì filter theo roomId
